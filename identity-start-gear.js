/* Alpha 0.34 v11 - single humble start + profession-specific equipment scoring */
(()=>{
 'use strict';
 ...
 renderStart=function(){
  ...
  app.innerHTML=`<div class="start"><h1>无尽战域：核心 Alpha 0.34</h1><p class="subtitle">从普通人开始，靠Boss掉落收集种族、职业与技能。</p>
   ...
   ${helpBlock('开局规则','不再提供种族或职业三选一。除人类与农民外，所有种族和职业都必须由Boss身份掉落永久解锁。职业技能练到Lv.10后可以永久传承；种族特性不能传承。')}
